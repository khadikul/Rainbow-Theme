  ...
  class CSF_Field_typography extends CSF_Fields {
      ...
      echo '<div class="csf--typography'. esc_attr( $chosen_class ) .'" data-depend-id="'. esc_attr( $this->field['id'] ) .'" data-unit="'. esc_attr( $args['unit'] ) .'" data-line-height-unit="'. esc_attr( $line_height_unit ) .'" data-exclude="'. esc_attr( $args['exclude'] ) .'">';
        ...
        echo '<div class="csf--blocks csf--blocks-selects">';
          ...
          if ( ! empty( $args['font_family'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Font Family', 'rainbow-cloud' ) .'</div>';
            echo $this->create_select( array( $this->value['font-family'] => $this->value['font-family'] ), 'font-family', esc_html__( 'Select a font', 'rainbow-cloud' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['backup_font_family'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Backup Font Family', 'rainbow-cloud' ) .'</div>';
            echo $this->create_select( apply_filters( 'csf_field_typography_backup_font_family', array(
              ...
              'Georgia, serif',
              'Palatino Linotype'
            ) ), 'backup-font-family', esc_html__( 'Default', 'rainbow-cloud' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Font Style', 'rainbow-cloud') .'</div>';
            echo '<select class="csf--font-style-select" data-placeholder="Default">';
            echo '<option value="">'. ( ! $this->chosen ? esc_html__( 'Default', 'rainbow-cloud' ) : '' ) .'</option>';
            ...
            if ( ! empty( $args['extra_styles'] ) ) {
              ...
              echo ( ! $this->chosen ) ? '<div class="csf--title">'. esc_html__( 'Load Extra Styles', 'rainbow-cloud' ) .'</div>' : '';
              $placeholder = ( $this->chosen ) ? esc_html__( 'Load Extra Styles', 'rainbow-cloud' ) : esc_html__( 'Default', 'rainbow-cloud' );
          ...
          if ( ! empty( $args['subset'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Subset', 'rainbow-cloud' ) .'</div>';
            $subset = ( is_array( $this->value['subset'] ) ) ? $this->value['subset'] : array_filter( (array) $this->value['subset'] );
            echo $this->create_select( $subset, 'subset', esc_html__( 'Default', 'rainbow-cloud' ), $args['multi_subset'] );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_align'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Align', 'rainbow-cloud' ) .'</div>';
            echo $this->create_select( array(
              'inherit' => esc_html__( 'Inherit', 'rainbow-cloud' ),
              'left'    => esc_html__( 'Left', 'rainbow-cloud' ),
              'center'  => esc_html__( 'Center', 'rainbow-cloud' ),
              'right'   => esc_html__( 'Right', 'rainbow-cloud' ),
              'justify' => esc_html__( 'Justify', 'rainbow-cloud' ),
              'initial' => esc_html__( 'Initial', 'rainbow-cloud' )
            ), 'text-align', esc_html__( 'Default', 'rainbow-cloud' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['font_variant'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Font Variant', 'rainbow-cloud' ) .'</div>';
            echo $this->create_select( array(
              'normal'         => esc_html__( 'Normal', 'rainbow-cloud' ),
              'small-caps'     => esc_html__( 'Small Caps', 'rainbow-cloud' ),
              'all-small-caps' => esc_html__( 'All Small Caps', 'rainbow-cloud' )
            ), 'font-variant', esc_html__( 'Default', 'rainbow-cloud' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_transform'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Transform', 'rainbow-cloud' ) .'</div>';
            echo $this->create_select( array(
              'none'       => esc_html__( 'None', 'rainbow-cloud' ),
              'capitalize' => esc_html__( 'Capitalize', 'rainbow-cloud' ),
              'uppercase'  => esc_html__( 'Uppercase', 'rainbow-cloud' ),
              'lowercase'  => esc_html__( 'Lowercase', 'rainbow-cloud' )
            ), 'text-transform', esc_html__( 'Default', 'rainbow-cloud' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_decoration'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Decoration', 'rainbow-cloud' ) .'</div>';
            echo $this->create_select( array(
              'none'               => esc_html__( 'None', 'rainbow-cloud' ),
              'underline'          => esc_html__( 'Solid', 'rainbow-cloud' ),
              'underline double'   => esc_html__( 'Double', 'rainbow-cloud' ),
              'underline dotted'   => esc_html__( 'Dotted', 'rainbow-cloud' ),
              'underline dashed'   => esc_html__( 'Dashed', 'rainbow-cloud' ),
              'underline wavy'     => esc_html__( 'Wavy', 'rainbow-cloud' ),
              'underline overline' => esc_html__( 'Overline', 'rainbow-cloud' ),
              'line-through'       => esc_html__( 'Line-through', 'rainbow-cloud' )
            ), 'text-decoration', esc_html__( 'Default', 'rainbow-cloud' ) );
            echo '</div>';
          }
        ...
        echo '<div class="csf--blocks csf--blocks-inputs">';
          ...
          if ( ! empty( $args['font_size'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Font Size', 'rainbow-cloud' ) .'</div>';
          ...
          if ( ! empty( $args['line_height'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Line Height', 'rainbow-cloud' ) .'</div>';
            echo '<div class="csf--input-wrap">';
          ...
          if ( ! empty( $args['letter_spacing'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Letter Spacing', 'rainbow-cloud' ) .'</div>';
            echo '<div class="csf--input-wrap">';
          ...
          if ( ! empty( $args['word_spacing'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Word Spacing', 'rainbow-cloud' ) .'</div>';
            echo '<div class="csf--input-wrap">';
        ...
        if ( ! empty( $args['color'] ) ) {
          ...
          echo '<div class="csf--title">'. esc_html__( 'Font Color', 'rainbow-cloud' ) .'</div>';
        ...
        if ( ! empty( $args['custom_style'] ) ) {
          ...
          echo '<div class="csf--title">'. esc_html__( 'Custom Style', 'rainbow-cloud' ) .'</div>';
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'csf-webfontloader' ) ) {
        ...
        wp_enqueue_script( 'csf-webfontloader', 'https://cdn.jsdelivr.net/npm/webfontloader@1.6.28/webfontloader.min.js', array( 'rainbow-cloud' ), '1.6.28', true );
        ...
        if ( ! empty( $customwebfonts ) ) {
          $webfonts['custom'] = array(
            'label' => esc_html__( 'Custom Web Fonts', 'rainbow-cloud' ),
            'fonts' => $customwebfonts
          );
        }

        $webfonts['safe'] = array(
          'label' => esc_html__( 'Safe Web Fonts', 'rainbow-cloud' ),
        ...
        $webfonts['google'] = array(
          'label' => esc_html__( 'Google Web Fonts', 'rainbow-cloud' ),
        ...
        wp_localize_script( 'rainbow-cloud', 'csf_typography_json', array(
          'webfonts'      => $webfonts,
