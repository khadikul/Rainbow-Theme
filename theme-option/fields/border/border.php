  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'top_placeholder'    => esc_html__( 'top', 'rainbow-cloud' ),
        'right_placeholder'  => esc_html__( 'right', 'rainbow-cloud' ),
        'bottom_placeholder' => esc_html__( 'bottom', 'rainbow-cloud' ),
        'left_placeholder'   => esc_html__( 'left', 'rainbow-cloud' ),
        'all_placeholder'    => esc_html__( 'all', 'rainbow-cloud' ),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__( 'Solid', 'rainbow-cloud' ),
        'dashed'    => esc_html__( 'Dashed', 'rainbow-cloud' ),
        'dotted'    => esc_html__( 'Dotted', 'rainbow-cloud' ),
        'double'    => esc_html__( 'Double', 'rainbow-cloud' ),
        'inset'     => esc_html__( 'Inset', 'rainbow-cloud' ),
        'outset'    => esc_html__( 'Outset', 'rainbow-cloud' ),
        'groove'    => esc_html__( 'Groove', 'rainbow-cloud' ),
        'ridge'     => esc_html__( 'ridge', 'rainbow-cloud' ),
