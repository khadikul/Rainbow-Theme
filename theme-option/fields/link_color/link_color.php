...
if ( ! class_exists( 'CSF_Field_link_color' ) ) {
  class CSF_Field_link_color extends CSF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'rainbow-cloud' ),
        'hover'    => esc_html__( 'Hover', 'rainbow-cloud' ),
        'active'   => esc_html__( 'Active', 'rainbow-cloud' ),
        'visited'  => esc_html__( 'Visited', 'rainbow-cloud' ),
        'focus'    => esc_html__( 'Focus', 'rainbow-cloud' )
      );
